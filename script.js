...
function clearContent() {
  ...
  // retira o bg do sinal da multiplicacao quando o clear é ativado
  let mult = document.getElementById("x");
  let icon = document.getElementById("icon");
  mult.style.backgroundColor = "#FF9F0A";
  icon.style.color = "#fff";
  mult.style.transition = "0.4s ease";

  // operacao da divisao
  let divisao = document.getElementById("divisao");
  let iconDiv = document.getElementById("iconDiv");
  divisao.style.backgroundColor = "#FF9F0A";
  ...
  soma.style.backgroundColor = "#FF9F0A";
  iconSoma.style.color = "#fff";
